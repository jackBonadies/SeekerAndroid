...
namespace Seeker.Serialization
{
    ...
    public class SerializationTests
    {
        ...
        public static void TestInflateAll(Android.App.Activity activity)
        {
                ...
                Resource.Layout.searchitemview_simple_bottom_dummy                ,
                Resource.Layout.searchitemview_simple_top_dummy                   ,
                Resource.Layout.searchitemview_modern_bottom_dummy                ,
                Resource.Layout.searchitemview_modern_top_dummy                   ,
                Resource.Layout.searchitemview_compact_dummy                      ,
                ...
                Resource.Layout.search_result_modern_top                          ,
                Resource.Layout.search_result_compact                             ,
