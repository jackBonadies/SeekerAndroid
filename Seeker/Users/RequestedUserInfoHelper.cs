            ...
            getUserInfoTask.ContinueWith(new Action<Task<UserInfo>>(
                (Task<UserInfo> userInfoTask) =>
                {
                    ...
                    else
                    {
                        ...
                        if (e.InnerException is SoulseekClientException && e.InnerException.Message.Contains(SimpleHelpers.FailedToEstablishDirectOrIndirectString, StringComparison.OrdinalIgnoreCase))
                        {
